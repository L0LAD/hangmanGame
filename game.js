(function($, window, undefined){
  ...
  var capital = ['Dublin', 'Tokyo', 'Pretoria', 'Mbabane", "Lisbon', 'Washington DC', 'Edinburgh', 'Paris', 'Madrid', 'Reykjavik', 'Athens', 'Moscow', 'Seoul', 'Beijing', 'London', 'Islamabad', 'Istanbul', 'New Delhi', 'Mexico city', 'Brazilia', 'Nouakchott', 'Bogota', 'Abu Dhabi', 'Oslo', 'Stockholm', 'Helsinki', 'Amsterdam', 'Niamey', 'Suva', 'Yerevan', 'Riyadh', 'Skopje', 'Vienna', 'Victoria', 'Nuku Alofa', 'Brussels', 'Minsk', 'Kyiv', 'Buenos Aires', 'Canberra', 'Wellington', 'Kingston', 'Ottawa', 'Nassau', 'Pyongyang', 'Hanoi', 'Kuala Lumpur', 'Bangkok', 'Kathmandu', 'Brazzaville', 'Lusaka', 'Tehran', 'Doha', 'Conakry', 'Georgetown', 'La Paz', 'Freetown', 'Kinshasa', 'Antananarivo', 'Vientiane', 'Palikir', 'Yamoussoukro', 'Yaounde', 'Bangui', 'Dodoma', 'Addis Ababa', 'Mogadishu', 'Quito', 'Lima', 'Manama', 'San Salvador', 'Budapest', 'Praha', 'Bucharest', 'Lilongwe'];
  var verb = ['argue', 'accuse', 'achieve', 'acknowledge', 'advise', 'afford', 'agree', 'apologize', 'bake', 'breathe', 'beg', 'break', 'build', 'carry(, (cook', 'cry', 'cut', 'destroy', 'develop', 'empty', 'drink', 'dislile', 'discover', 'drive', 'doubt', 'drag', 'delay', 'earn', 'dry', 'enhance', 'examine', 'exist', 'be', 'finnish', 'feel', 'fly', 'foolow', 'forbit', 'forget', 'freeze', 'fry', 'give', 'go', 'grow', 'hang', 'have', 'hide', 'hit', 'hope', 'hurry', 'identify', 'imply', 'improve', 'introduce', 'jump', 'justify', 'keep', 'kiss', 'kneel', 'lack', 'laught', 'lay', 'learn', 'lie', 'light', 'lift', 'like', 'look', 'make', 'rush', 'switch', 'wish', 'yield', 'want', 'put', 'pour', 'pray', 'roll', 'try', 'emphasize', 'embelish', 'sing', 'seek', 'scream', 'shout', 'sleep', 'wake up'];
  ...
  var words = {capital:capital, verb:verb, sport:sport, internet:internet, food:food, animal:animal, country:country};
